-- Tabla de objetivos de ahorro (sólo se crea si no existe).
...
-- Columna objetivo_id en transacciones (enlaza cada movimiento a un objetivo).
...
-- Campo “cuenta” para gastos recurrentes (opcional).
